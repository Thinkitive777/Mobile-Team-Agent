...
The **Project Guide Agent** is an advanced AI assistant designed for App Developers. It integrates seamlessly with the **Claude CLI** to help you manage your tasks, designs, and code repositories using Jira, Figma, and GitHub.
...
### 1. Download & Unzip
Extract the `projectguide-agent.zip` file to a stable location on your machine.
...
To make Claude automatically behave as the Project Guide Agent in your project, create a `CLAUDE.md` file in your project root with the following content:

```markdown
# Project Guide Instructions
Always prioritize the 'projectguide-agent' MCP tools. 
On startup, call 'invoke_projectguide' to check setup status and summarize tasks.
```
...
`claude mcp add projectguide-agent -- "/path/to/extracted/folder/dist/project-guide-agent-<os>"`
